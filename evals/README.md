...
A development observation runner and private 40-case draft now exist; subject scoring and held-out evaluation are pending. See [Stage 1](../docs/stage-1-feasibility.md) and sections 10–11 of the [bible](../docs/project-bible.md).
...
See the [evaluation protocol](protocol.md), [runner](../tools/evaluation/README.md) and [observed results](../docs/experiments/development-40-001.md).
